CREATE TABLE connectors (
    ...
    connector_number INTEGER NOT NULL CHECK (connector_number > 0),
    type VARCHAR(20) NOT NULL,
    max_power_kw NUMERIC(10, 2) NOT NULL CHECK (max_power_kw > 0),
    max_voltage INTEGER NOT NULL CHECK (max_voltage > 0),
    max_current INTEGER NOT NULL CHECK (max_current > 0),
