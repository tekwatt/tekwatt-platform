...
export type Reservation = { id:string;tenantId:string;userId:string;chargerId:string;connectorId:string;reference:string;status:string;startsAt:string;expiresAt:string;createdAt:string;updatedAt:string };
export type Invoice = { id:string;tenantId:string;userId?:string;billId?:string;invoiceNumber:string;customerName:string;customerEmail:string;billingAddress?:string;taxRegistrationNumber?:string;subtotal:number;taxAmount:number;totalAmount:number;currency:string;status:string;issueDate?:string;dueDate?:string;issuedAt?:string;paidAt?:string;createdAt:string;updatedAt:string };
...
export type TicketHistory = { id:string;ticketId:string;eventType:string;fromValue?:string;toValue?:string;actorName?:string;createdAt:string };
export type TicketDetail = { ticket:SupportTicket;comments:TicketComment[];history:TicketHistory[] };
